...
const (
	SimpleService_Echo_FullMethodName = "/simple.SimpleService/Echo"
)
...
func (c *simpleServiceClient) Echo(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	out := new(SimpleResponse)
	err := c.cc.Invoke(ctx, SimpleService_Echo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSimpleServiceServer) Echo(context.Context, *SimpleRequest) (*SimpleResponse, error) {
